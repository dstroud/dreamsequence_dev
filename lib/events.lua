...
for seq_no = 1, max_seqs do									
  ...
  table.insert(events_lookup, {	category = "Seq " .. seq_no, 	subcategory= 'Config', 	event_type= 'param', 	id= "seq_start_on_" .. seq_no, 	name= 'Play', 	value_type= 'continuous', 			})
  ...
  table.insert(events_lookup, {	category = "Seq " .. seq_no, 	subcategory= 'Pattern', 	event_type= 'param', 	id= "seq_start_" .. seq_no, 	name= 'Start', 	value_type= 'trigger', 			})
  table.insert(events_lookup, {	category = "Seq " .. seq_no, 	subcategory= 'Pattern', 	event_type= 'param', 	id= "seq_reset_" .. seq_no, 	name= 'Reset', 	value_type= 'trigger', 			})
  ...
  table.insert(events_lookup, {	category = "Seq " .. seq_no, 	subcategory= 'Pattern', 	event_type= 'param', 	id= "seq_rotate_" .. seq_no, 	name= 'Pattern rotate', 	value_type= 'continuous', 			})
