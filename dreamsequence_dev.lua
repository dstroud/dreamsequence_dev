...
function countdown()
  ...
  -- local pulse = {1,2,3,4,5,6,5,4,3,2}
  -- local direction = fast_pulse_1_4 == 6 and (~ direction) or direction
  
  fast_pulse_1_4 = util.wrap(fast_pulse_1_4 - 1, 1, 4)
  
  steps_sixteen = util.wrap((steps_sixteen or 0) + 1, 1, 16)


  -- print(steps_sixteen)
  -- print(fast_pulse_1_4)
